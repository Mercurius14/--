...
def encrypt_or_decrypt():
    ...
    if encrypt_or_decrypt_var.get() == '加密':
        ...
        if mode == '二进制':
            ...
            cipher_text = ''.join(encrypt_char(char, key_entry.get()) for char in input_entry.get())
        ...
        if mode == '二进制':
            ...
            decrypted_text = ''.join(decrypt_char(char, key_entry.get()) for char in input_entry.get())
